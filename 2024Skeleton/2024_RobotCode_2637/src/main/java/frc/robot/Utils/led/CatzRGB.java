...
public class CatzRGB 
{
    ...
    public ColorMethod oneColorFillAllianceColor = (color) -> {
        fillLEDBuffer(enumToAllianceColor(CatzAutonomous.chosenAllianceColor.get()));
    };
    ...
    public void LEDPeriodic()
    {
        if(RobotContainer.currentGameModeLED == RobotContainer.gameModeLED.TeleOp){
            ...
            fillLEDBuffer(LEDSections.ElevatorL.start, LEDSections.ElevatorL.end, RobotContainer.elevatorControlMode.color);
            fillLEDBuffer(LEDSections.ArmR.start, LEDSections.ArmR.end, RobotContainer.armControlMode.color);
            fillLEDBuffer(LEDSections.IntakeR.start, LEDSections.IntakeR.end, RobotContainer.intakeControlMode.color);
            fillLEDBuffer(LEDSections.ElevatorR.start, LEDSections.ElevatorR.end, RobotContainer.elevatorControlMode.color);
        }
        else{
            RobotContainer.currentGameModeLED.method.execute(RobotContainer.currentGameModeLED.color);
        }
